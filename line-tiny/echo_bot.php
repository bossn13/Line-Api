            ...
            switch ($message['type'])
            {
                case 'text':
                    ...
                    {//login url
                        ...
                        $bubble_txt = '{"type":"bubble","hero":{"type":"image","url":"https://scdn.line-apps.com/n/channel_devcenter/img/fx/01_1_cafe.png","size":"full","aspectRatio":"20:13","aspectMode":"cover","action":{"type":"uri","uri":"' . $url_login .'"}},"body":{"type":"box","layout":"vertical","contents":[{"type":"text","text":"เข้าสู่ระบบ","weight":"bold","size":"xl"},{"type":"box","layout":"vertical","margin":"lg","spacing":"sm","contents":[{"type":"box","layout":"baseline","spacing":"sm","contents":[{"type":"text","text":"สามารถเข้าสู่ระบบเพื่อใช้งานระบบงานอหท. ผ่าน Line ได้ด้วยเลขประจำตัว และรหัสผ่านเดียวกับ e-mail กฟผ.","wrap":true,"color":"#666666","size":"sm","flex":1}]}]}]},"footer":{"type":"box","layout":"vertical","spacing":"sm","contents":[{"type":"button","style":"primary","height":"sm","action":{"type":"uri","label":"กดที่นี่เพื่อเข้าสู่ระบบ","uri":"'. $url_login .'"}},{"type":"spacer","size":"sm"}],"flex":0}}';
